...
class MagnetGalleryAdapter : RecyclerView.Adapter<MagnetGalleryAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val imageViewMagnetImage = itemView.findViewById<AppCompatImageView>(R.id.imageViewMagnetImage)
        fun onBind(image: String) {
            ...
            imageViewMagnetImage.setOnClickListener {
                ...
                Glide.with(itemView).load(image).into(view.findViewById<AppCompatImageView>(R.id.imageViewData))
                alert.setView(view)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.viewholder_magnet_image, parent, false)
        )
    }
